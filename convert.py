...
def serialize_meta_banner(meta_item_tag):
    ...
    # TODO: Serialize meta banner (to be implemented)
    # https://hub.spigotmc.org/stash/projects/SPIGOT/repos/craftbukkit/browse/src/main/java/org/bukkit/craftbukkit/inventory/CraftMetaBanner.java
    return meta
...
def serialize_meta_compass(meta_item_tag):
    ...
    # TODO: Serialize compass (to be implemented)
    # https://hub.spigotmc.org/stash/projects/SPIGOT/repos/craftbukkit/browse/src/main/java/org/bukkit/craftbukkit/inventory/CraftMetaCompass.java
    return meta
